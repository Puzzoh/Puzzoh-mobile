    ...
    return (
        <SafeAreaView style={styles.safeContainer}>
            <View style={styles.container}>
                ...
                <Text style={styles.subHeading}>Select up to 3 of your interest and let us know what you are passionate about</Text>
                <View style={styles.spaceSmall} />
                {Array.from({ length: Math.ceil(interests.length / 2) }, (_, i) => i * 2).map(rowStartIndex => (
                    <View style={styles.row} key={rowStartIndex}>
                        {interests.slice(rowStartIndex, rowStartIndex + 2).map((interest, idx) => {
